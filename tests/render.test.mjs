...
describe("every other row", () => {
  ...
  // What one Worker said to another is on the Leader's panel too, sender, arrow, addressee, on a
  // ground of its own — not a prompt to the Leader either — under the id both Workers' lines
