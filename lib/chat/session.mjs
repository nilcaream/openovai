...
export function start(instance, seat, { asked = nobodyToAsk, ended = nothing, turned = nothing, queue = [], gate = () => null, held = nothing, typing = () => ({ quiet: 0, cap: 0 }), changed = nothing, called = nothing, returned = nothing, failed = nothing, said = nothing } = {}) {
