...
// A queue with no User frame in it waits for the turn's end, as ever. A close never joins: it is
// read at the start of a turn of its own, so a seat is never asked to close in the middle of a
// step, and whatever arrived after it waits with it. Answers whether it wrote.
