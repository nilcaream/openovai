...
export const EVENTS = Object.freeze(["user-typed", "overheard", "context", "restarted", "quota-low", "idle", "stopped", "park", "permission", "admin-closed", "checkpoint", "undelivered", "died", "closing"]);
