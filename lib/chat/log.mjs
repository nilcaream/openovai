...
export const EVENTS = new Set([
  ...
  "restart", // a restart that could not be given a successor
  "held", // a turn held for a quota window
  "released", // a held turn let go
  "quota", // the quota gate could not be told a stage
...
// A process gone takes its calls out with it: nothing will come back for them.
export function ended(seat) {
