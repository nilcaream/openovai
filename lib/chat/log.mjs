...
export const EVENTS = new Set([
  ...
  "died", // a turn came back an error from the service: what it said, verbatim
  "closed", // a close reached its deadline with no desk written: why, and when the desk last was
  ...
  "redelivered", // an event the ending Leader never read, delivered once more
  ...
  "held", // a turn held for a quota window, or while the User types on the seat's panel
