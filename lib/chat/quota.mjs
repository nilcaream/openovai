...
// instance names it — `quota.windows["7d-fable"]` in openovai.json. Its thresholds have a default
// like the other two, so an instance that never names it has nothing to configure and nothing
// to be told. It applies to the models its pattern names and to no other.
