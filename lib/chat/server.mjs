  ...
  return [
    {
      ...
      async run(args) {
        ...
        // The answer is a message the other way, under an id of its own: a row on the one who
        // answered and a row on the one who asked, so the Leader's panel carries the whole
        // exchange in the middle and a Worker sees the answer land before its call comes back.
        const answer = {
          from: to,
          to: caller.seat,
          text: reply.text,
