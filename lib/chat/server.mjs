...
import { DeskError, LEDGER, LISTS, allowAsked, archiveFor, deskFile, hire as openDesk, isModel, isName, modelFor, nextName, retire as closeDesk, ruleAsked, writeDeskWhole } from "../desks.mjs";
