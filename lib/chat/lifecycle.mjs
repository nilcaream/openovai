...
// The effort the instance's sessions run at: `effortLevel` in the instance's own settings, the
// file Claude Code reads for the working directory. Nothing when none is set — the head then
// names the model alone.
export function effortOf(instance) {
  const level = readSettings(instance.root).effortLevel;
