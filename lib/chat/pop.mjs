...
import { SERVER, append } from "./conversation.mjs";
...
// lib/ either, for the reason a plugin is not: taking a newer version of the toolkit replaces
...
// per process, so reading the directory again later would find a NEW file and go on running the stale
