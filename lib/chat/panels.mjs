...
// What the User's own row says of itself, beside its stamp: delivered once the frame it became
// has gone into the process; until then waiting — queued behind the turn under way when the
// seat is busy, sending otherwise. A waiting word is drawn as a wait.
export const SENDING = "sending…";
export const DELIVERED = "delivered ✓";

export function delivery(delivered, busy, name) {
  if (delivered) return { text: DELIVERED, wait: false };
