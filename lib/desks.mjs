...
// because the desk directory around it is granted for both (deskRules), and a deny wins over an
// allow only for the tool it names. One segment for the name, so it is every desk here and
// nothing beside them.
