...
import { DESK_DENY_RULES, DESK_TEMPLATE, OWN_ACCOUNT_RULES, READ_RULES, REPOSITORY_RULES, TOOL_RULES, TREE_RULES, deskFile, deskRules, readTemplate, render } from "./desks.mjs";
...
function settingsToStartWith(leader) {
  return {
    permissions: {
      allow: [...TOOL_RULES, ...READ_RULES, ...TREE_RULES, ...REPOSITORY_RULES, ...deskRules(leader)],
