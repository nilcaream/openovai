...
async function startServer(root) {
  ...
  // Written the moment the child exists, which is well before it has loaded enough of itself to
  // say anything; the offset is where this run's own output begins.
  const header = `--- ovai start: server pid ${child.pid} at ${stamp(new Date(), zoneOf())}\n`;
