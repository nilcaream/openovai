...
import { listening } from "./chat/runtime.mjs";
...
// because what the page shows is read from desks/ rather than remembered.
//
...
function hireHere(root, name, model) {
  ...
  const written = hire(root, name, model ?? null);
...
async function chat(root) {
  ...
  // (lib/chat/session.mjs); what is printed here is which of the things on it exist today.
